...
<body class="fundofixo">
  ...
  <main class="">
    ...
    <nav>
      <br>
    <h2 class="h2-1 text-info" style="text-align: center;">QUEM SOMOS</h2>
    </nav>
    <br>
      ...
      <div class="row">
        <div class="col">
          <figure class="image1">
            ...
            <titulo class="titulo text-info">Missão</titulo>
            <br>
        ...
        <div class="col">
          <figure class="image2">
            ...
            <titulo class="titulo text-info">Visão</titulo>
            <br>
        ...
        <div class="col">
          <figure class="image3">
            ...
            <titulo class="titulo text-info">Valores</titulo>
            <br>
