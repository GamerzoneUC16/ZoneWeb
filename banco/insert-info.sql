...
insert produtos ( titulo, descricao, resumo, preco, destaque, tipo_id) values ( 'ACER Monitor Gamer Nitro KG282K 28" 3840x2160 4K UHD IPS, PRETO', '28 POLEGADAS c/ resolução de 3840 x 2160, taxa de atualização de 160HZ', 'Monitor Gamer ACER 28pol', 2650.00, 'sim', 11);
insert produtos ( titulo, descricao, resumo, preco, destaque, tipo_id) values ( 'Intel Processador Core i9-13900K', 'Desktop 24 núcleos (8 P-core + 16 E-cores) 36M Cache, até 5,8 GHz, Até 5,8 GHz desbloqueado. 36M de cache; Compatível com placas-mãe Intel série 600 e série 700 baseadas em chipsets; Tecnologia Turbo Boost Max 3.0 e suporte PCIe 5.0 e 4.0. Suporte Intel Optane Memory. Nenhuma solução térmica incluída', 'Processador Intel CORE I9', 4200.00, 2);
